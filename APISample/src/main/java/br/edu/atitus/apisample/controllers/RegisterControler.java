...
public class RegisterControler {
	...
	public RegisterControler(RegisterService service, UserService userService) {
		super();
	...
	public ResponseEntity<RegisterEntity> createRegister(@RequestBody RegisterDTO registerDTO) throws Exception {
		...
		//quando a autentificação estiver funcionando, pega-se o usuário autenticado
